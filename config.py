...
ROBOT_TARGET = [-161.91, 158.80, 198.23, -0.014, -0.024, -0.447]

# 任务二三区拍照位；None时跳过移动，便于先测固定相机或调试图。
TASK2_CARD_VIEW_POSE = [-139.31, -110.62, 145.03, -0.014, -0.023, -0.541]
TASK2_BLOCK_VIEW_POSE = [-376.22, -206.43, 259.54, 0.000, 0.000, -0.445]
TASK2_TRAY_VIEW_POSE = [-373.07, 94.50, 259.54, 0.000, 0.000, -0.411]
...
ROBOT_SAFE_TRANSIT_Z_MM = 300.0          # 跨区域移动安全高度；需低于实机上限且高于台面障碍
ROBOT_MAX_ABS_ORIENTATION_RAD = 3.25     # 拒绝明显误填的deg姿态（AUBO位姿统一使用rad）
